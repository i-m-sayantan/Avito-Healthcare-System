<?php include('header.php'); ?>
	...
	<div class="contactus"  style="background-color:#fff;">
		<h3 class="text-center" style="background-color:#E79B4F;color: #fff;">Contact Us</h3>
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2>Sayantan Das<h2><h4>Studied B.Tech in Computer Science and Engineering</h4>
							<h5>Bengal Institute Of Technology , Kolkata</h5>
						<p> https://www.facebook.com/sayantan.das.58511276<br>
						    sayantan.das013@gmail.com<br>
							cell: 6295514790</p><br>
				</article>
			</div>
			<div class="col-md-6">
